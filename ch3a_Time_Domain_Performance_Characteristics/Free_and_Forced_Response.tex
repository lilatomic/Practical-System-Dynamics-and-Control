...
\begin{section}{Definition}
	\definition{Free Response} The free response of a system is the response to the initial conditions, with no forcing functions.
	
	\definition{Forced Response} The forced response of a system is the response to the forcing function with 0 initial conditions.
